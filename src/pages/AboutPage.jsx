...
function AboutPage() {
  return (
    <>
      <h3 className="text-lg font-semibold text-center mt-12 mx-6 
      lg:mt-8 lg:text-2xl ">
        "Travelling leaves you speachless, then turns you into a storyteller"
      </h3>
      <p className="text-md px-12 py-12 text-center mb-6
      ...
      lg:ml-44">
        ...
        <div className="">
          <div className="shadow-lg border-solid border rounded-xl p-6 flex flex-row w-10/12">
            <div className="">
              <img src={Lu} className="w-64 aspect-ratio: 1 / 1 shadow-lg border-solid border rounded-xl mt-4" />
            </div>
            <div>
              <h3 className="text-center text-lg font-semibold 
              lg:text-xl">
              ...
              lg:text-lg">
                ...
                changed my life. It ignited my passion for travel,
